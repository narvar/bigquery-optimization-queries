# Production Cost Analysis: monitor_base.ft_benchmarks_latest
...
2. **Manual updates** - Populated by manual queries
3. **View, not table** - May be a view on shipments with first-time delivery logic
...
4. **Purpose:** What are "FT benchmarks"? (First-Time delivery?)
...
- fashionnova uses this view minimally (1.53 slot-hours total from Phase 1)
- No operations in 5-month window suggests very low frequency or view
...
**Used By View:** v_benchmark_ft (minimal usage by fashionnova: 1.53 slot-hours)  
