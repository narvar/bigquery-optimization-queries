-- This query returns how many slots were used on a per second basis across billing projects.
-- Adds reusable root-job filtering to avoid counting child script jobs twice.
