-- Returns queries with highest billed bytes across all billing projects.
-- Includes reusable parentJobName-based root-job filtering.
...
WITH raw_events AS (
  SELECT
    protopayload_auditlog.servicedata_v1_bigquery.job.jobName.jobId AS jobId,
