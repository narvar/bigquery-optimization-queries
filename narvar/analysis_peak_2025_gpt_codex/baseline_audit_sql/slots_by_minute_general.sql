-- This query returns how many slots were used on a per minute basis (all billing projects).
-- Applies reusable root-job filtering logic via parentJobName detection.
