-- DTPL-6903: Detailed Job-Level Analysis for Worst Delays
-- 
-- Purpose: Get granular details on queries with significant delays
--          to understand exactly what was happening
--
-- Focus: Queries with >60 second queue time
--
