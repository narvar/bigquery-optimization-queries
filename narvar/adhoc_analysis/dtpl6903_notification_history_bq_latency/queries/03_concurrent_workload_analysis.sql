-- DTPL-6903: Concurrent Workload Analysis
-- 
-- Purpose: Identify what other services/users were competing for slots
--          when messaging queries experienced delays
--
-- This helps answer: "What's hogging the slots?"
--
-- Expected bytes processed: ~100-150 GB (7 days audit logs)
...
-- Get all users/projects in the reservation, ranked by resource consumption
